// ============================================================
// 🔧 SITE CONFIGURATION - แก้ไขข้อมูลธุรกิจได้ที่นี่
// ============================================================
...
export const siteConfig = {
  ...
  features: [
    {
      title: "RELAX",
      description: "Let go of tension and stress with our signature relaxation therapies designed for deep calm.",
      icon: "leaf",
    },
    {
      title: "REFRESH",
      description: "Revitalize your senses with invigorating treatments that restore your natural energy.",
      icon: "droplets",
    },
    {
      title: "REJUVENATE",
      description: "Turn back the clock with our premium anti-aging and skin renewal treatments.",
      icon: "sparkles",
    },
  ],
    ...
    highlights: [
      {
        ...
        description:
          "Our therapists are internationally certified with 5+ years of experience. Each team member undergoes rigorous training to master both traditional and contemporary techniques.",
        icon: "users",
      },
      {
        title: "Premium Quality",
        description:
          "We use only the finest organic products and essential oils, sourced from trusted suppliers worldwide. Your safety and satisfaction are our top priorities.",
        icon: "award",
      },
      {
        title: "Luxurious Ambiance",
        description:
          "Step into our serene oasis featuring private treatment rooms, aromatic gardens, and a tranquil atmosphere designed to transport you to a world of peace.",
        icon: "home",
      },
    ],
